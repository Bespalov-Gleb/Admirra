...
def create_integration(
    ...
    encrypted_access = security.encrypt_token(integration.access_token)
    encrypted_refresh = security.encrypt_token(integration.refresh_token) if integration.refresh_token else None
