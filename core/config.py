...
def get_config() -> Config:
    ...
    return Config(
        ...
        detector=DetectorCfg(
            ...
            plan_spend_warning_deviation=float(_env("DETECTOR_PLAN_SPEND_WARNING_DEVIATION", "0.10")),
            ...
            plan_cpl_warning_ratio=float(_env("DETECTOR_PLAN_CPL_WARNING_RATIO", "1.1")),
