    ...
    <div class="mb-10">
      ...
      <div class="mt-8 flex flex-wrap items-center gap-[10px]">
        ...
        <button
          type="button"
          :class="[
            'box-border flex h-[46px] w-[152px] shrink-0 flex-row items-center gap-[10px] rounded-[12px] px-[17px] py-[15px] text-[14px] font-medium leading-tight transition-colors',
            billingPeriod === 'year'
              ? 'bg-[#2563EB] text-white shadow-sm'
              : 'bg-[#FFFFFF] text-[#475569] shadow-sm hover:bg-gray-100',
          ]"
