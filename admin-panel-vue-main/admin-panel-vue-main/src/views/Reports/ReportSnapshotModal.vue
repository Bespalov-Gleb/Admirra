    ...
    <div class="snapshot-backdrop" @click.self="$emit('close')">
      <section class="snapshot-modal" :class="{ 'is-dark': isDarkMode }">
        ...
        <div class="snapshot-body">
          ...
          <img v-else-if="imageUrl" :src="imageUrl" alt="Зафиксированный отчёт" />
