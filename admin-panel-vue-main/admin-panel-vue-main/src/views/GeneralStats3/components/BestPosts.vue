  ...
  <div class="bg-white rounded-2xl p-6 sm:p-8 border border-gray-100 shadow-md">
    ...
    <div v-else class="flex gap-6 overflow-x-auto pb-3 custom-scrollbar">
      <div
        v-for="post in posts"
        :key="post.id"
        class="flex-shrink-0 w-80 rounded-2xl overflow-hidden border border-gray-100 hover:shadow-xl hover:scale-[1.02] transition-all duration-300 shadow-md"
      >
        ...
        <div class="p-5 bg-white">
          <div class="flex flex-wrap gap-x-4 gap-y-1.5 text-sm font-medium text-gray-600">
