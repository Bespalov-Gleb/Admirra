          ...
          >
            ...
            <td class="px-4 py-4 text-right">
              <div class="flex flex-col items-end gap-1">
                ...
                <span v-if="campaign.trend_cost != null" :class="trendClass(campaign.trend_cost)">
            ...
            <td class="px-4 py-4 text-right">
              <div class="flex flex-col items-end gap-1">
                ...
                <span v-if="campaign.trend_impressions != null" :class="trendClass(campaign.trend_impressions)">
            ...
            <td class="px-4 py-4 text-right">
              <div class="flex flex-col items-end gap-1">
                ...
                <span v-if="campaign.trend_clicks != null" :class="trendClass(campaign.trend_clicks)">
            ...
            <td class="px-4 py-4 text-right">
              <div class="flex flex-col items-end gap-1">
                ...
                <span v-if="campaign.trend_cpc != null" :class="trendClass(campaign.trend_cpc)">
            ...
            <td class="px-4 py-4 text-right">
              <div class="flex flex-col items-end gap-1">
                ...
                <span v-if="campaign.trend_conversions != null" :class="trendClass(campaign.trend_conversions)">
            ...
            <td class="px-6 py-4 text-right rounded-r-2xl">
              <div class="flex flex-col items-end gap-1">
                ...
                <span v-if="campaign.trend_cpa != null" :class="trendClass(campaign.trend_cpa)">
...
const rowBgClass = (idx) => {
  const variants = ['bg-amber-50/60', 'bg-emerald-50/60', 'bg-sky-50/60', 'bg-gray-50/80']
  return variants[idx % 4]
}

const trendClass = (val) => [
  'inline-flex items-center gap-0.5 text-[11px] font-bold px-2 py-0.5 rounded-lg',
