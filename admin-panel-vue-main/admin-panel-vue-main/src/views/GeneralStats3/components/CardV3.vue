<template>
  ...
  >
    ...
    <div class="flex items-start justify-between gap-2 mb-3">
      ...
      <button
        type="button"
        class="w-7 h-7 rounded-full bg-gray-100 dark:bg-white/10 flex items-center justify-center text-gray-400 hover:bg-gray-200 hover:text-gray-600 dark:hover:text-gray-300 transition-colors flex-shrink-0"
