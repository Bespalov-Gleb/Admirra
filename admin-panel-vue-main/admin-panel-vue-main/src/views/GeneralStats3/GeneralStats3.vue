...
.dashboard-service-sources { display:flex; align-items:center; flex-wrap:wrap; gap:.54rem; min-width:0; }
.dashboard-source-chip,.dashboard-source-add { display:inline-flex; align-items:center; gap:.48rem; min-height:2.4rem; padding:.336rem .864rem; border:0; border-radius:999px; font-size:1.032rem; font-weight:650; white-space:nowrap; }
.dashboard-source-chip { background:#fcf1dc; color:#1a1a1a; }.dashboard-source-chip img { width:1.296rem; height:1.296rem; object-fit:contain; }.dashboard-source-chip--vk { background:#edf4ff; color:#1a1a1a; }.dashboard-source-chip--vk img { width:1.5rem; height:1.5rem; }.dashboard-source-chip--avito { background:#eef8f2; color:#1a1a1a; }
...
@media (max-width: 640px) {
  ...
  /* Метаданные («В норме» · синхро · НДС) на десктопе прижаты вправо
     (margin-left:auto + justify-content:flex-end). На мобилке блок переносится
     под заголовок — выравниваем его содержимое к левому краю, вровень с h1. */
