        ...
        <div class="wizard-grid">
          <div class="wizard-panel dark:!bg-[#2C2F3D] dark:!border dark:!border-white/10">
            ...
            <p v-if="form.platform === 'YANDEX_DIRECT' && connectAsOrg" class="org-hint dark:!text-white/50">
              На экране Яндекса войдите аккаунтом, который добавлен в организацию (кнопка «Выбрать аккаунт»), — тогда Яндекс предложит выбрать организацию и «Войти как Сотрудник». Кнопка появляется только у сотрудников организации.
            </p>
