<template>
  <div class="relative z-[2] flex min-h-full flex-col overflow-hidden px-[25px] py-[30px]">
    <div v-if="loading" class="flex justify-center py-24 text-[rgba(105,105,105,0.56)] text-sm font-medium">
      Загрузка тарифов…
    </div>
    ...
    <template v-else>
      ...
      <p class="text-[15px] font-medium text-[rgba(105,105,105,0.56)] mb-[25px]">
      ...
      <div class="flex pb-[30px]">
        <div class="flex gap-[20px]">
          <button
            class="tab-btn"
            :class="{ 'tab-btn--active': billingPeriod === 'month' }"
          ...
          <button
            class="tab-btn"
            :class="{ 'tab-btn--active': billingPeriod === 'year' }"
      ...
      <div :key="billingPeriod" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-[30px]">
        ...
        <div class="plan-card">
          <div class="flex flex-col h-full" style="row-gap:25px">
            <h4 class="flex items-center gap-[15px] text-[20px] font-semibold leading-none text-[#171717]">
              <span class="two-circles"></span>
              Старт
            </h4>
            <div>
              <div class="text-[50px] font-semibold leading-none text-[#171717] mb-[10px]">
                {{ currentPrice(resolvedPlans.start) }}
              </div>
              <div class="text-[15px] font-light text-[rgba(105,105,105,0.56)]">
            ...
            <ul class="flex-1">
              <li v-for="item in planBullets(resolvedPlans.start)" :key="item" class="feature-row">
                ...
                <span class="text-[15px] text-[#5f5f5f] leading-[1.12]">{{ item }}</span>
              </li>
            </ul>
            <div>
              <button
      ...
      <!-- White Label -->
      <div class="bg-white rounded-[30px] p-[30px]">
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
          ...
          <div class="pr-[30px] flex flex-col gap-[20px]">
            <div class="flex items-start gap-[17px]">
              ...
              <h4 class="text-[20px] font-semibold leading-[1.3] text-[#171717]">
                White Label —<br />
                персонализация<br />
          ...
          <div class="flex flex-col" style="padding:8px 0 0 40px">
            <div class="mb-[16px]">
              <div class="text-[50px] font-semibold leading-none text-[#171717] mb-[10px]">25&nbsp;900&nbsp;₽</div>
              <div class="text-[15px] font-light text-[rgba(105,105,105,0.56)]">259 руб/проект</div>
            </div>
            <p class="text-[15px] text-[rgba(105,105,105,0.56)] max-w-[200px] pt-[10px] mb-[45px]">
