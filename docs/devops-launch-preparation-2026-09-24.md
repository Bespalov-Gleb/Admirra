...
**Обновление после этого протокола:** владелец подтвердил сохранение recovery key;
миграции, API1/API2, frontend, consumers и scheduler активированы. Публичный
canary проходит ступени наблюдения. Актуальные факты:
[production cutover](devops-production-cutover-2026-09-24.md).
Ниже — сохранённый исторический протокол подготовки, не текущий статус.
