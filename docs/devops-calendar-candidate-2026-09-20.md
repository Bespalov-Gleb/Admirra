...
> После этой итерации подключены Telegram alerts и расширен диск API-2; см. [актуальный остаток](devops-remaining-2026-09-20.md). Пункт об отсутствии выбранного получателя ниже исторический. Calendar candidate по-прежнему не включён в production.
