...
> Обновление 20.09 вечером: observe-only дополнен прямыми Telegram critical/recovery уведомлениями, persistent retry/dedup и systemd drop-in. Текущее состояние: [devops-telegram-alerts-2026-09-20.md](devops-telegram-alerts-2026-09-20.md). Нижеследующее сохраняет историю первоначального развёртывания.
