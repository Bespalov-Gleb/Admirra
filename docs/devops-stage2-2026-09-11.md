...
Продолжение: `docs/devops-stage3-2026-09-11.md` — recipient guards, shared Metrika read-cache,
durable backfill; image-only 271 passed. Ниже сохранён исторический статус этапа 2.
