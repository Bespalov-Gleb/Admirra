...
try:
    ...
    tests = ['tests/test_oauth_signup_analytics.py','tests/test_signup_discount.py','tests/test_purchase_analytics.py','tests/test_signup_discount_flow.py','tests/test_onboarding.py','tests/test_onboarding_ingress.py',
